...
const cardVariants = staggeredFadeUp(0.1);
      ...
      <div className="section-container relative z-10">
        ...
        >
          {ctaActions.map((action, index) => (
            <motion.div key={action.title} variants={cardVariants} custom={index} className="col-span-12 md:col-span-6 lg:col-span-4 flex">
              <div className="w-full bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/10 hover:border-white/20 transition-all duration-300 flex flex-col justify-between group">
