...
export default function ApproachSection() {
  return (
    <section
      id="approach"
      className="bg-slate-50 dark:bg-darklight transition-colors duration-300 overflow-hidden py-10 sm:py-12 lg:py-14"
    >
        ...
        <motion.div initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.4 }}>
          ...
          <div className="hidden lg:block relative">
            ...
            <div className="absolute top-6 left-[10%] right-[10%] h-0.5 -translate-y-1/2 z-0">
              <div className="absolute inset-0 rounded-full bg-primary/15 dark:bg-white/10" />
              <motion.div
                variants={lineDrawX}
            ...
            <div className="flex items-start relative z-10">
              {STEPS.map((step, i) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-extrabold text-slate-900 dark:text-white mb-1 leading-tight">
                    {step.label}
                  </h3>
              ...
              {STEPS.map((step, i) => (
                ...
                >
                  ...
                  <div className="flex-1 pb-2">
                    <h3 className="text-base font-extrabold text-slate-900 dark:text-white mb-1 leading-tight">
                      {step.label}
                    </h3>
