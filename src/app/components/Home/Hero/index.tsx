  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex-1 flex">
        <div className="container mx-auto max-w-[92vw] 2xl:max-w-[1680px] px-4 sm:px-6 md:px-8 lg:px-12 w-full flex items-stretch lg:h-full">
          <div className="grid grid-cols-12 w-full items-stretch gap-y-6 lg:gap-x-12 xl:gap-x-16 2xl:gap-x-24 lg:h-full">

            {/* ───── LEFT COLUMN ───── */}
            <div className="lg:col-span-7 col-span-12 flex flex-col justify-center pt-24 sm:pt-28 lg:pt-20 pb-6 lg:pb-8 lg:h-full">
              <motion.div
                initial={{ y: 15, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ duration: 0.5 }}
                className="flex flex-col gap-6 sm:gap-8 lg:gap-5"
              >
                <div className="flex flex-col gap-4 lg:gap-3">
                  {/* Badge */}
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary dark:bg-primary/20 dark:text-blue-300 font-bold text-[10px] sm:text-xs uppercase tracking-wider mb-1 w-fit select-none">
                  ...
                  {/* Heading */}
                  <h1 className="text-slate-900 dark:text-white mb-0 text-[1.75rem] sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-extrabold leading-tight tracking-tight">
                  ...
                  {/* Subtext */}
                  <p className="text-sm sm:text-base md:text-lg lg:text-base xl:text-lg font-medium text-slate-500 dark:text-slate-400 leading-relaxed max-w-xl xl:max-w-2xl">
                ...
                {/* Animated Stats Row */}
                <div className="flex flex-wrap items-center gap-6 sm:gap-8 md:gap-12 lg:gap-14 pt-4 sm:pt-6 border-t border-slate-200 dark:border-slate-800">
                  {STATS.map((stat, i) => (
                    <div key={i} className="flex flex-col">
                      <div className="text-xl sm:text-2xl md:text-3xl lg:text-3xl font-extrabold text-slate-900 dark:text-white leading-none">
                        <CountUp end={stat.end} suffix={stat.suffix} />
                      </div>
                      <div className="text-[9px] sm:text-[10px] lg:text-[10px] text-slate-500 dark:text-slate-400 mt-1 sm:mt-1.5 font-bold uppercase tracking-wider leading-none">
                        {stat.label}
                      </div>
                    </div>
                  ))}
            ...
            {/* ───── RIGHT COLUMN — Image ───── */}
            <div className="lg:col-span-5 col-span-12 flex justify-center items-center pb-6 sm:pb-8 lg:pt-20 lg:pb-8 relative lg:h-full">
              ...
              <motion.div
                ...
                className="relative z-10 w-full max-w-[340px] sm:max-w-[500px] lg:max-w-none lg:w-[95%] lg:h-[50vh] xl:h-[55vh] 2xl:h-[60vh] lg:-translate-x-12 rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-200 dark:border-darkborder shadow-2xl bg-slate-50 group"
              >
                <Image
